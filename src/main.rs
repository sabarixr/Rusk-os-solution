...
print!("{}",ASCII_AMFOSS_top);                      // fix
print!("{}",ASCII_AMFOSS_bottom);


  rusk_os::init(); //initialises essential kernel functions     // fix
...
// fix , there exist a dup panic fn here if removed any one then its correct
